...
public class FeatureReportGenerator {
    ...
    public void generateFeatureOverview() throws Exception {
		...
		context.put("cucumber_jvm_html_reports", Messages.FeatureReportGenerator_CucumberJVMHtmlReports());
		context.put("feature_overview", Messages.FeatureReportGenerator_FeatureOverview());
		context.put("back_to_jenkins", Messages.FeatureReportGenerator_BackToJenkins()); 
		context.put("tag_overview", Messages.FeatureReportGenerator_TagOverview()); 
		context.put("feature_overview_for_build", Messages.FeatureReportGenerator_FeatureOverviewForBuild());
		context.put("feature_overview_for_build_description", Messages.FeatureReportGenerator_FeatureOverviewForBuildDescription());
		context.put("this_page_requires_AC_RunActiveContent", Messages.FeatureReportGenerator_ThisPageRequiresACRunActiveContent());
		context.put("this_content_requires_the_Adobe_Flash_Player", Messages.FeatureReportGenerator_ThisContentRequiresTheAdobeFlashPlayer());
		context.put("this_content_requires_javascript", Messages.FeatureReportGenerator_ThisContentRequiresJavaScript());
		context.put("feature_statistics", Messages.FeatureReportGenerator_FeatureStatistics());
		context.put("feature", Messages.FeatureReportGenerator_Feature());
		context.put("scenarios", Messages.FeatureReportGenerator_Scenarios());
		context.put("steps", Messages.FeatureReportGenerator_Steps());
		context.put("passed", Messages.FeatureReportGenerator_Passed());
		context.put("failed", Messages.FeatureReportGenerator_Failed());
		context.put("skipped", Messages.FeatureReportGenerator_Skipped());
		context.put("pending", Messages.FeatureReportGenerator_Pending());
		context.put("duration", Messages.FeatureReportGenerator_Duration());
		context.put("status", Messages.FeatureReportGenerator_Status());
        ...
        context.put("totals", Messages.FeatureReportGenerator_Totals());
    ...
    public void generateFeatureReports() throws Exception {
        ...
        while (it.hasNext()) {
            ...
            for (Feature feature : featureList) {
                ...
                VelocityContext context = new VelocityContext();
				context.put("cucumber_jvm_html_reports", Messages.FeatureReportGenerator_CucumberJVMHtmlReports());
				context.put("feature_title", Messages.FeatureReportGenerator_Feature());
                context.put("feature", feature);
				context.put("feature_overview", Messages.FeatureReportGenerator_FeatureOverview());
				context.put("back_to_jenkins", Messages.FeatureReportGenerator_BackToJenkins()); 
				context.put("tag_overview", Messages.FeatureReportGenerator_TagOverview()); 
                context.put("feature_result_for_build", Messages.FeatureReportGenerator_FeatureResultForBuild());
				context.put("scenarios_title", Messages.FeatureReportGenerator_Scenarios());
				context.put("steps", Messages.FeatureReportGenerator_Steps());
				context.put("passed", Messages.FeatureReportGenerator_Passed());
				context.put("failed", Messages.FeatureReportGenerator_Failed());
				context.put("skipped", Messages.FeatureReportGenerator_Skipped());
    ...
    public void generateTagReports() throws Exception {
        for (TagObject tagObject : allTags) {
			...
			context.put("feature_overview", Messages.FeatureReportGenerator_FeatureOverview());
			context.put("back_to_jenkins", Messages.FeatureReportGenerator_BackToJenkins()); 
			context.put("result_for", Messages.FeatureReportGenerator_ResultFor()); 
			context.put("in_build", Messages.FeatureReportGenerator_InBuild()); 
            context.put("tag_label", Messages.FeatureReportGenerator_Tag());
			context.put("scenarios", Messages.FeatureReportGenerator_Scenarios());
			context.put("steps", Messages.FeatureReportGenerator_Steps());
			context.put("passed", Messages.FeatureReportGenerator_Passed());
			context.put("failed", Messages.FeatureReportGenerator_Failed());
			...
			context.put("duration", Messages.FeatureReportGenerator_Duration());
			context.put("status", Messages.FeatureReportGenerator_Status());
			context.put("view_feature_file", Messages.FeatureReportGenerator_ViewFeatureFile());
    ...
    public void generateTagOverview() throws Exception {
		...
		context.put("feature_overview", Messages.FeatureReportGenerator_FeatureOverview());
		context.put("back_to_jenkins", Messages.FeatureReportGenerator_BackToJenkins()); 
		context.put("tag_overview_for_build", Messages.FeatureReportGenerator_TagOverviewForBuild());
		context.put("tag_overview_for_build_description", Messages.FeatureReportGenerator_TagOverviewForBuildDescription());
		context.put("you_have_no_tags_in_your_cucumber_features", Messages.FeatureReportGenerator_YouHaveNoTagsInYourCucumberFeatures());
		context.put("this_page_requires_AC_RunActiveContent", Messages.FeatureReportGenerator_ThisPageRequiresACRunActiveContent());
		context.put("this_content_requires_the_Adobe_Flash_Player", Messages.FeatureReportGenerator_ThisContentRequiresTheAdobeFlashPlayer());
		context.put("this_content_requires_javascript", Messages.FeatureReportGenerator_ThisContentRequiresJavaScript());
		context.put("tag_statistics", Messages.FeatureReportGenerator_TagStatistics());
		context.put("tag_label", Messages.FeatureReportGenerator_Tag());
		context.put("scenarios", Messages.FeatureReportGenerator_Scenarios());
		context.put("steps", Messages.FeatureReportGenerator_Steps());
		context.put("passed", Messages.FeatureReportGenerator_Passed());
